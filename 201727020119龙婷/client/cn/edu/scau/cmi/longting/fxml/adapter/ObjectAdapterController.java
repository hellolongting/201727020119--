...
import cn.edu.scau.cmi.longting.adapter.SortObjectAdapter;
...
public class ObjectAdapterController implements Initializable{
    ...
    private Sort sort = new SortObjectAdapter();
